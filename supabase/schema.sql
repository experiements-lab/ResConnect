-- ResConnect schema for Supabase
-- Run this in: Supabase Dashboard > SQL Editor > New query
-- Note: auth.users is managed by Supabase Auth — do not create it.

-- Students (identity_id references Supabase auth.users.id)
CREATE TABLE IF NOT EXISTS students (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    identity_id UUID UNIQUE NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
-- In-app notifications (identity_id references Supabase auth.users.id for either a student or landlord)
